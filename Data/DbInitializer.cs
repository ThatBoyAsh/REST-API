    ...
    public class DbInitializer
    {
        ...
        public void Seed()
        {
            _modelBuilder.Entity<Author>(a =>
            {
                ...
                a.HasData(new Author
                {
                    Id = new Guid("e618869f-8d4e-47b4-a80a-f730f6c3c192"),
                    Name = "Katlego Sponkane",
                    DateOfBirth = new DateTime(1952, 05, 20)
                });
            });

            _modelBuilder.Entity<Book>(b =>
            {
                b.HasData(new Book
                {
                ...
                b.HasData(new Book
                {
                    Id = new Guid("b157a71e-512c-4c8e-9766-9f2e94d013b8"),
                    Title = "Person of Interest",
                    Description = "The government uses AI to spy on its people",
                    Genre = Genre.Biography,
                    Publisher = "Simon & Schuster; 3rd edition (October 24, 2000)",
                    ISBN = "978-1451648509",
                    Rating = 5.0,
                    AuthorId = new Guid("e618869f-8d4e-47b4-a80a-f730f6c3c192")
                });
            });
        }
    }
